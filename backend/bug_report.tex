            ...
            \section{\large Executive Summary}
                ...
                \pie[color={critical, high, medium, low, info}, text=inside]{
                    ...
                    0/High,
                    0/Medium,
                    66.66666666666666/Low,
                    33.33333333333333/Info
                }
                \end{tikzpicture}
            ...
            \end{center}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{temp-image-0-0.png}
\includegraphics[width=1.0\textwidth]{temp-image-0-1.png}
\includegraphics[width=1.0\textwidth]{temp-image-0-2.png}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{temp-image-1-0.png}
\includegraphics[width=1.0\textwidth]{temp-image-1-1.png}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{temp-image-2-0.png}
\includegraphics[width=1.0\textwidth]{temp-image-2-1.png}
