            ...
            \begin{flushleft}
                \huge Aurm ios  Application Security Assessment Report.
            \end{flushleft}                
            \end{minipage}
            \vspace{80pt}

            \large Aurm ios  Application
            ...
            \section{\large Executive Summary}
                ...
                \normalsize The scope of this penetration test was limited to the URL mentioned below: 
                    \begin{center}
                        ...
                        \hline
                        \normalsize 1. & \normalsize Aurm & \normalsize \url{https://aurm.in} & \normalsize Aurm ios  Application Manually \& using Burpsuite \\
                        \hline
                        \end{longtable} 
                    \end{center}  
                ...
                \begin{tikzpicture}
                \centering
                \pie[color={high,low}, text=inside, radius=\piechartRadius]{
                    50/High,50/Low
                }
                \end{tikzpicture}
...
The attacker can execute javascript on the victims account just after the authentication process.
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{OWASP Category: A05-Security Misconfigurationl}
                        \item \large \textbf{CVSS Score:} 2.8 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{sd}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large sd
                        ...
                        \item \large \textcolor{linkColor}{\url{sd}}
