            ...
            \begin{flushleft}
                \huge vaptlabs Android Application Security Assessment Report.
            \end{flushleft}                
            \end{minipage}
            \vspace{80pt}

            \large vaptlabs Android Application
            ...
            \section{\large Executive Summary}
                ...
                \normalsize The scope of this penetration test was limited to the URL mentioned below: 
                    \begin{center}
                        ...
                        \hline
                        \normalsize 1. & \normalsize vaptlabs & \normalsize \url{https://ibpsonline.ibps.in/rrb} & \normalsize vaptlabs Android Application Manually \& using Burpsuite \\
                        \hline
                        \end{longtable} 
                    \end{center}  
    ...
    \end{longtable}
            \end{center}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{CVSS Score:} 5.8 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{t}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large t
