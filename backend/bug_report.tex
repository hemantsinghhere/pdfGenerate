            ...
            \begin{flushleft}
                \huge Google ios Application Security Assessment Report.
            \end{flushleft}                
            \end{minipage}
            \vspace{80pt}

            \large Google ios Application
            ...
            \section{\large Executive Summary}
                ...
                \normalsize The scope of this penetration test was limited to the URL mentioned below: 
                    \begin{center}
                        ...
                        \hline
                        \normalsize 1. & \normalsize Google & \normalsize \url{www.google.com} & \normalsize Google ios Application Manually \& using Burpsuite \\
                        \hline
                        \end{longtable} 
                    \end{center}  
                ...
                \begin{tikzpicture}
                \centering
                \pie[color={critical}, text=inside, radius=\piechartRadius]{
                    100/Critical
                }
                \end{tikzpicture}
    ...
    \end{longtable}
            \end{center}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{CVSS Score:} 9 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{gh}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large gh
                        ...
                        \item \large \textcolor{linkColor}{\url{fre}}
