...
\includegraphics[width=1.0\textwidth]{Images/temp-image-0-2.png}
                        ...
                        \item \large \underline{\href{links} {links}}
                        \end{enumerate}
...
\includegraphics[width=1.0\textwidth]{Images/temp-image-1-1.png}
                    ...
                    \newpage
                    \subsection{\large form}
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        \item \large \textbf{Status:} new
                        \item \large \textbf{Severity: \textcolor{infotext} {info}}
                        \item \large \textbf{OWASP Category: severity}
                        \item \large \textbf{CVSS Score:} 2.6 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
