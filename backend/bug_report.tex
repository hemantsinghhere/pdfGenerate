            ...
            \newcommand{\urlstring}[1]{egin{quote}\url{#1}\end{quote}}
            ...
            \section{\large Executive Summary}
                ...
                \begin{tikzpicture}
                \centering
                \pie[color={medium}, text=inside, radius=\piechartRadius]{
                    100/Medium
                }
                \end{tikzpicture}
            ...
            \begin{center}
                \begin{longtable} {|p{2em}|p{20em}|>{\raggedright\arraybackslash}p{7em}|>{\centering\arraybackslash}p{4em}|>{\centering\arraybackslash}p{3em}|}
                    ...
                    \normalsize \center 1 & \normalsize Stored XSS on reports & \normalsize A03-Injection   & \normalsize \textbf{\textcolor{medium}{Medium}} &  4.5 \\
                    \hline
                    

                    \normalsize \center 2 & \normalsize Unrestricted File Upload on https://app.lemlist.com & \normalsize A04-Insecure Design  & \normalsize \textbf{\textcolor{medium}{Medium}} &  5.3 \\
                    \hline
            ...
            \hline
                    ...
                    Stored XSS on reports & Quick \\
                    \hline
                    Unrestricted File Upload on https://app.lemlist.com & Planned \\
                    \hline\end{longtable}
            \end{center}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{CVSS Score:} 4.5 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{https://app.mopub.com}
\item \large \url{https://app.mopub.com/reports/custom/}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large Stored XSS, also known as persistent XSS, is the more damaging than non-persistent XSS. It occurs when a malicious script is injected directly into a vulnerable web application.
                        ...
                        \item \large Go to \url{https://app.mopub.com/reports/custom/}

                        \item \large Click New network report.

                        \item \large On the name, enter payload: "><img src=x onerror=alert(document.domain)>

                        \item \large Click Run and save then XSS will trigger.
                        \end{enumerate}
...
\item \large The attacker can steal data from whoever checks the report. 
                        ...
                        \item \large \url{https://hackerone.com/reports/485748}

                        \item \large \url{https://hackerone.com/reports/485741}
                    ...
                    \newpage
                    \subsection{\large Unrestricted File Upload on https://app.lemlist.com}
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        \item \large \textbf{Status:} New
                        \item \large \textbf{Severity: \textcolor{infotext} {Medium}}
                        \item \large \textbf{OWASP Category: A04-Insecure Design}
                        \item \large \textbf{CVSS Score:} 5.3 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{https://app.lemlist.com}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large Hi! i found an Unrestricted File Upload on \url{https://app.lemlist.com} which let me upload anything.
File Extensions Such as .html and others should not be executed on the server side.
                            
                        \item \large \textbf{Screenshot:} \\ \\
                        \includegraphics[width=1.0\textwidth,height=0.5\textheight,keepaspectratio]{Images/temp-image-1-0.png} \\
                        ...
                        \item \large Login to \url{https://app.lemlist.com}

                        \item \large Go to Settings > Email Signature > Click the 3 Dots > Upload File

                        \item \large Download page.html (F617851) and Upload it

                        \item \large Right Click and Get the Link of the Uploaded File, Visit the Link.
                        \end{enumerate}
                        
                        \item \large \textbf{Impact:}
                        \linespread{1.0}
                        \begin{enumerate}[leftmargin=0.5cm]
                        \item \large An attacker can bypass upload restrictions and deface the page. 
                        \end{enumerate}  
                        ...
                        \item \large Stop Unrestricted File Upload to the server

                        \item \large Validate the extensions of Files.
                        \end{enumerate}
                        ...
                        \item \large \url{https://hackerone.com/reports/722919}

                        \item \large \url{https://docs.imagekit.io/api-reference/api-introduction/api-keys?\_gl=1*1fefd2z*\_gcl\_au*MTc4MDg1NzY3MS4xNzE4OTUzODA4*\_ga*NzUyNzE1NDg3LjE3MTg5NTM4MDg.*\_ga\_WQGX7PLP73*MTcxODk1OTk1Ny4yLjEuMTcxODk2MDEzMi42MC4wLjA.}

                        \item \large \url{https://imagekit.io/dashboard/developer/api-keys}
