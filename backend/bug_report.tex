            ...
            \section{\large Executive Summary}
                ...
                \normalsize \cellcolor{black!10} \textbf{Severity} & \normalsize \cellcolor{black!10} \textbf{Count} \\
                 ...
                 \hline
                 \normalsize Low & \normalsize \cellcolor{low} 3 \\
                 \hline
                 \normalsize Informational & \normalsize \cellcolor{info} 0 \\
                 \hline
                 \normalsize Total & \normalsize \cellcolor{total} 3 \\
                 \hline    
                \end{tabular}
                \end{minipage}
            ...
            \begin{center}
                \begin{longtable} {|p{3em}|p{15em}|p{6em}|c|c|}
                    ...
                    \normalsize \center \textbf{1} & \normalsize \textbf{mumbai} & \normalsize \textbf{A05-security Misconfiguration} & \normalsize \textbf{\textcolor{low}{Low}} &  2.8 \\
                    \hline
                    

                    \normalsize \center \textbf{2} & \normalsize \textbf{submit form } & \normalsize \textbf{A05-security Misconfiguration} & \normalsize \textbf{\textcolor{low}{Low}} &  2.5 \\
                    \hline
            ...
            \end{center}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{OWASP Category: severity}
                        \item \large \textbf{CVSS Score:} 2.8 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \href{host} {host}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  as

                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{Images/temp-image-0-0.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-0-1.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-0-2.png}
                        ...
                        \item \large \underline{\href{add reference} {add reference}}
                        \end{enumerate}
                    ...
                    \newpage
                    \subsection{\large submit form }
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        \item \large \textbf{Status:} new
                        \item \large \textbf{Severity: \textcolor{infotext} {low}}
                        \item \large \textbf{OWASP Category: severity}
                        \item \large \textbf{CVSS Score:} 2.5 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \href{affected} {affected}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  summary

                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{Images/temp-image-1-0.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-1-1.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-1-2.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-1-3.png}

                        \item \large \textbf{Steps of Reproduce:}
                        \linespread{1.0}
                        \begin{enumerate}[leftmargin=0.5cm]
                            
                        \item \large steo,tekf
                        \end{enumerate}
                        
                        \item \large \textbf{Impact:}
                        \linespread{1.0}
                        \begin{enumerate}[leftmargin=0.5cm]
                        \item \large impact,impact 
                        \end{enumerate}  
                        ...
                        \item \large \underline{\href{reference} {reference}}
                        \end{enumerate}
                    ...
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        ...
                        \item \large \textbf{Screenshot:} \\ \\
                            \includegraphics[width=1.0\textwidth]{Images/temp-image-2-0.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-2-1.png}
\includegraphics[width=1.0\textwidth]{Images/temp-image-2-2.png}
