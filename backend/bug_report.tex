            ...
            \section{\large Executive Summary}
                ...
                \begin{tikzpicture}
                \centering
                \pie[color={high,medium}, text=inside, radius=\piechartRadius]{
                    50/High,50/Medium
                }
                \end{tikzpicture}
            ...
            \begin{center}
                \begin{longtable} {|p{2em}|p{20em}|>{\raggedright\arraybackslash}p{7em}|>{\centering\arraybackslash}p{4em}|>{\centering\arraybackslash}p{3em}|}
                    ...
                    \normalsize \center 1 & \normalsize Stored XSS on reports. & \normalsize A05-Security Misconfiguration  & \normalsize \textbf{\textcolor{medium}{Medium}} &  4 \\
                    \hline
                    

                    \normalsize \center 2 & \normalsize Cross-Site Scripting (XSS) on www.starbucks.com | .co.uk login pages & \normalsize A03-Injection   & \normalsize \textbf{\textcolor{high}{High}} &  7.3 \\
                    \hline
     ...
     Cross-Site Scripting (XSS) on www.starbucks.com | .co.uk login pages &  Planned \\
    \hline
...
\includegraphics[width=1.0\textwidth,height=0.5\textheight,keepaspectratio]{Images/temp-image-0-1.png} \\
                        ...
                        \item \large we can sanitize the HTML characters
                        \end{enumerate}
                        ...
                        \item \large \textcolor{linkColor}{\url{https://hackerone.com/reports/485748}}
                    ...
                    \newpage
                    \subsection{\large Cross-Site Scripting (XSS) on www.starbucks.com | .co.uk login pages}
                    \begin{description}[itemsep=2pt, leftmargin=0.2cm]
                        \item \large \textbf{Status:} New
                        \item \large \textbf{Severity: \textcolor{infotext} {High}}
                        \item \large \textbf{OWASP Category: A03-Injection }
                        \item \large \textbf{CVSS Score:} 7.3 
                        \item \large \textbf{Affected Hosts/URLs:}
                            \begin{itemize} 
                            \item \large \url{https://www.starbucks.com/account/signin}
\item \large \url{https://www.starbucks.co.uk/account/signin}
                            \end{itemize}
                        \item \large \textbf{Summary:} \\  \large The login page at \url{https://www.starbucks.com/account/signin} builds several links by the relative URL path. An attacker can actually control the relative path:
                        ...
                        \item \large Open Chrome or Firefox

                        \item \large Visit \url{https://www.starbucks.com/account/(A(\%22\%20\%252fonmouseover=\%22alert\%25\%32\%38\%64\%6f\%63\%75\%6d\%65\%6e\%74.\%64\%6f\%6d\%61\%69\%6e\%25\%32\%39\%22))/signin} and in the upper right-hand corner, move your mouse over the "Find the Store" button.

                        \item \large The XSS will trigger and you'll get an alert() with the value of document.domain
                        \end{enumerate}
                        
                        \item \large \textbf{Impact:}
                        \linespread{1.0}
                        \begin{enumerate}[leftmargin=0.5cm]
                        \item \large Attacker will hijack your sessions 
                        \end{enumerate}  
                        ...
                        \item \large Sanitize HTMl characters is a good practice

                        \item \large Dompurify javascript library can be used to remediate this.
                        \end{enumerate}
                        ...
                        \item \large \textcolor{linkColor}{\url{https://hackerone.com/reports/881115}}
